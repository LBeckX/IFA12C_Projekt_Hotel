...
/**
 * The Class for the mySql-Table [mitarbeiter]
 * @author Lukas Beck
 * @link https://github.com/lbeckx
 * @version 1.0.170130
 * Class sqlMitarbeiter
 */
class sqlMitarbeiter{
   ...
   public function selectAllFromTableById($id = 'all'){
     ...
     * @return bool
     */
   public function insertIntoTable($nachname,$vorname,$hotelID){
