<?php
/**
 * The Class for the mySql-Table [hotel]
 * @author Lukas Beck
...
class sqlHotel{
   ...
   public function selectAllFromTableById($id = 'all'){
    ...
    /**
     * Return value from table by id
     * if $name = 'all' it will return all from table.
     * @param string $name
     * @return array|bool
     */
   public function selectAllFromTableByName($name = 'all'){
	   $sql = 'SELECT * FROM `'.$this->tableName.'` WHERE `hotelname` = \''.$name.'\'';
     ...
     * @return bool
     */
   public function insertIntoTable($hotelName,$hotelOrt){
