...
-- Date: Fri, 10 Feb 2017 17:39:31 +0100
...
SET autocommit=0;
INSERT INTO `gast` VALUES (1,'schmidt','herbert','male',-314845200,0,'blumenstraÃŸe 4','gartenhausen','91827','gg@bla.de'),(2,'meier','hans','male',5871600,0,'sandkastenstraÃŸe 4','gartenhausen','91827','blabla@dd.de'),(3,'huber','isabell','female',326757600,0,'teichstraÃŸe 4','gartenhausen','91827','hubaBuba@123.de'),(4,'mÃ¼ller','gÃ¼nter','male',647560800,0,'baumstraÃŸe 4','gartenhausen','91827','1234@web.de'),(5,'mayer','isolde','female',968536800,0,'buschstraÃŸe 4','gartenhausen','91827','mitster@rr.de');
...
CREATE TABLE `rechnung` (
  ...
  `gastzimmerID` int(6) DEFAULT NULL,
...
-- Dump completed on: Fri, 10 Feb 2017 17:39:31 +0100
